...
<html>
   ...
   <body class="no_wiggle_webkit" style="top: 0px;">
         ...
         <div class="regular-header clearfix">
            ...
            <ul class="nav pull-right logged-out list-unstyled medium-right-margin">
               <li class="pull-left medium-right-margin">
                  ...
                  <a href="#" class="link-reset" id="headerUserName" rel="nofollow" style="line-height: 34px;">
      ...
      <div class="page-container page-container-responsive row-space-top-4">
         <h1 class="h2 row-space-4" id="conversationWidth">
         </h1>
         <div class="row">
            <div class="col-lg-12">
         ...
         <div class="row">
            <div class="col-lg-8">
               <ul id="thread-list" class="list-unstyled">
                ...
                <ul id="thread-list-top-message" class="list-unstyled">
                ...
                <ul id="bottom-messages" class="list-unstyled">  
            ...
            <div class="col-lg-4">
               <div class="panel row-space-4">
                  <div class="mini-profile va-container media">
                     ...
                     <div class="va-middle">
                        <div class="h4">
                           <a href="#" class="text-normal" id="ownerName"></a>
                           <br>
                           <small>
                           Member since 2015
                           </small>
